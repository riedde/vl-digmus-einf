...
font:     Source Sans 3
tags:     digitalitaet, analog, digital, hybrid
-->
...
- Name
- Studienfach
- "Digital bedeutet für mich... / Digitalität hat für mich zu tun mit..."
...
************************************************
 ...
 > Y-Achse: Das Thema interessiert mich
 > X-Achse: Das Thema macht mir Angst
************************************************

                {{4-5}}
************************************************
 > Y-Achse: Digitalität ist längst Standard
 > X-Achse: Ich denke viel über das Thema nach
...
************************************************
 ...
 > Y-Achse: Ich kenne mich mit digitalen Techniken aus
 > X-Achse: Ich verwende digitale Techniken
************************************************
...
``` ascii    Stufen der Digitalität von basis-Digitalisierung bis volldigital
     +---------------------+             ^ maximum 
     | Codierung / Edition |             |
     +---------------------+             |
                |                        |
...
> Man kann mich und die in den 1960er Jahren Geborenen vielleicht als die erste digitale Generation beschreiben.18 Dabei war der erste PC eben mehr als bloß eine bessere Schreibmaschine.
>
> – Armin Nassehi: Muster. Theorie der digitalen Gesellschaft, München 2019, S. 23.

> Veränderungen bei der Textproduktion eines jungen Wissenschaftlers bzw. eines Jungen, der einer werden wollte. Der Computer als Schreibgerät hat das Schreiben nicht einfach vereinfacht oder beschleunigt – es geht also nicht um Fragen der Skalierbarkeit. Der Computer als Schreibgerät hat das Schreiben entstofflicht. Bevor Text auf analoge Weise aufs Papier kommt, lebt er in einem virtuellen Zustand. Seine Virtualität besteht darin, dass er permanent veränderbar bleibt, ohne als Ganzes verändert werden zu müssen.
>
> – Nassehi: Muster, S. 24.
